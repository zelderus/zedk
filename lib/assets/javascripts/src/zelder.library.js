...
/*
    ...
    zelder.library.StringFormat(...)               - форматирование строки. первый аргумент строка-формал (some {0} text). последующие аргументы заменители
    zelder.library.StringEndsWith(str, suffix)     - заканчивается ли строка на suffix
    zelder.library.StringStartsWith(str, prefix)   - начинается ли строка с prefix
    zelder.library.PluralStr(i, str1, str2, str3)  - множественная форма слова EX: PluralStr(12, ‘товар’,'товара’,'товаров’); = 12 товаров
    zelder.library.StringReplaceBrackets(str, replacer?)   - удаляет все скобки и их содержимое
...
/** ---------------------------------------------------------------------------------------------------------------------------
*   StringFormat(...)   - форматирование строки.
*       неограниченное количество параметров 
*           - первый параметр строка формат ('some {0} text {1}.'); 
*           - последующие заменители
*/
if (!zelder.library.StringFormat) {
    zelder.library.StringFormat = function () {
        var s = arguments[0];
...
/// ===========================================================================================================================
/** ---------------------------------------------------------------------------------------------------------------------------
*   StringEndsWith(suffix)  - заканчивается ли строка на suffix
*/
if (!zelder.library.StringEndsWith) {
    zelder.library.StringEndsWith = function (str, suffix) {
        return (str.substr(str.length - suffix.length) === suffix);
    };
};
/// ===========================================================================================================================
/** ---------------------------------------------------------------------------------------------------------------------------
*   StringStartsWith(prefix)    - начинается ли строка с prefix
*/
if (!zelder.library.StringStartsWith) {
    zelder.library.StringStartsWith = function (str, prefix) {
...
/** ---------------------------------------------------------------------------------------------------------------------------
*   PluralStr(i, str1, str2, str3)  - множественная форма слова
*       EX: PluralStr(12, ‘товар’,'товара’,'товаров’); // 12 товаров
*/
if (!zelder.library.PluralStr) {
    zelder.library.PluralStr = function(i, str1, str2, str3) {
...
/** ---------------------------------------------------------------------------------------------------------------------------
*   StringReplaceBrackets(str, replacer?)   - удаляет все скобки и их содержимое
*/
if (!zelder.library.StringReplaceBrackets) {
    zelder.library.StringReplaceBrackets = function (str, /*str?*/replacer) {
        return str.replace(/\(.*\)/gm, !replacer ? '' : replacer);
    };
};
/// ===========================================================================================================================